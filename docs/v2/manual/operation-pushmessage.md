...
- Android应用：《Android SDK 使用说明》中 [*5 消息推送* ](./sdk-android.md/#5-消息推送 ) 部分
- iOS应用：《iOS SDK 使用说明》中 [*5 消息推送* ](./sdk-ios.md/#5-消息推送 ) 部分

### 3. 在方舟中选择消息通知服务商进行[服务集成配置](./project-integrations.md)
...
支持插入用户属性推送个性化的消息（用户属性需要通过 SDK 上报，详见《[SDK指南](./sdk.md)》）

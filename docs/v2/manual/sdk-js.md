...
JS SDK 用于由 HTML 、 Css 及 Javascript 制作成的网站，集成前请先[下载 SDK](https://ark.analysys.cn/sdk/v2/analysys_paas_JS_v4.2.0.1_20190124.zip)

|  js文件 |  功能描述| 是否必须 |
| :-: | :-: | :-: |
| AnalysysAgent_JS_SDK.min.js | 基础模块SDK | 必须 |
| AnalysysAgent_JS_SDK_VISUAL.min.js | 可视化模块SDK | 可选 |

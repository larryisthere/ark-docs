...
![ ](https://imguserradar.analysys.cn/fangzhou/img/2018/08/201808141246577875.png)

### 1. 定义指标区

左侧为指标定义区域，选择要分析的指标，细分维度查看，支持条件过滤，观察指标表现

![ ](https://imguserradar.analysys.cn/fangzhou/img/2018/08/201808141251267255.png)
...
> 注意：在集成 SDK 时，不同类型的属性值需要满足不同的数据格式，才能在分析时正确使用，详见《[SDK指南》](../../integration/integration-prepare/integration-data-type.md)。

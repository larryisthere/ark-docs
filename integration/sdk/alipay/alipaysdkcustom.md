---
description: 支付宝小程序通用框架版 SDK 使用说明
---
...
| js文件 | 功能描述 | 是否必须 |
| :---: | :---: | :---: |
| AnalysysAgent\_Alipay\_SDK.custom.min.js | 框架版SDK | 二选一 |
| AnalysysAgent\_Alipay\_SDK.custom.es6.min.js | 框架版ES6语法SDK | 二选一 |
...
页面跟踪，支付宝SDK需要手动设置跟踪所有页面，支持自定义页面信息。接口如下：
